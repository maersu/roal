...
*/
#include "TriangleMeshSegment.h"

namespace Roal
{
//------------------------------------------------------------------------------
TriangleMeshSegment::TriangleMeshSegment(Roal::Body* owner, std::string name, std::string meshFile)
...
//------------------------------------------------------------------------------
TriangleMeshSegment::~TriangleMeshSegment()
{
...
//------------------------------------------------------------------------------
void TriangleMeshSegment::initSegment(OgreOde::Space* space)
{
    // Visuals (Ogre Stuff)
    ...
    tmg = ei.createStaticTriangleMesh(space); 
    ...
    this->setOgreBody(tmg->getBody());

}


//------------------------------------------------------------------------------
void TriangleMeshSegment::setScale(float x, float y, float z)
{
   this->xScale = x; 
   this->yScale = y;     
   this->zScale = z; 
   ...
   if (this->getIsRunnable()) {
     ...
     /**
      * @bug during a running simualation calling this method could results in
