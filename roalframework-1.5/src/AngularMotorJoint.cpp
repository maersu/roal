...
*/
#include "AngularMotorJoint.h"

namespace Roal
{
    
//------------------------------------------------------------------------------
AngularMotorJoint::AngularMotorJoint(Roal::Position* anchor)
:Joint(anchor)
{ 
}
...
//------------------------------------------------------------------------------
void AngularMotorJoint::setAxis(const Vector3 &axis)
{
    this->axis = axis;   
}
...
//------------------------------------------------------------------------------
void AngularMotorJoint::initJoint()
{
    // do the Ogre/Ode stuff
    this->setOgreJoint(new OgreOde::AngularMotorJoint());
