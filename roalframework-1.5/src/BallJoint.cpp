...
//------------------------------------------------------------------------------
BallJoint::BallJoint(Roal::Position* anchor)
:Joint(anchor)
{ 
}
...
//------------------------------------------------------------------------------
void BallJoint::setAxis(const Vector3 &axis1, const Vector3 &axis2)
{
    this->axis1 = axis1;
    this->axis2 = axis2;   
}
...
//------------------------------------------------------------------------------
void BallJoint::initJoint()
{
    this->setOgreJoint(new OgreOde::BallJoint());
