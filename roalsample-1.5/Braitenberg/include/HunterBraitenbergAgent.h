...
*/
#ifndef _HUNTERBRAITENBERGAGENT_H_
#define _HUNTERBRAITENBERGAGENT_H_
...
/**
 * HunterBraitenbergAgent is the Agent implementation for the Braitenberg Example.
 ...
 */
class HunterBraitenbergAgent : public Agent
{
public:
     ...
     */
    HunterBraitenbergAgent(const string name, World* world, int populationSize, 
...
#endif //_HUNTERBRAITENBERGAGENT_H_
