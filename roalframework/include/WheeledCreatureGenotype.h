...
*/
#ifndef _WHEELEDCREATUREGENOTYPE_H_
#define _WHEELEDCREATUREGENOTYPE_H_
...
/**
 * WheeledCreatureGenotype is the Genotype implementation for the WheeledCreature creature.
 * @see Genotype
 * 
 ...
 */
class WheeledCreatureGenotype : public Genotype
{
public:
    /**
     * Constructor
     * 
     */
	WheeledCreatureGenotype();
    
    /**
     * Destructor.
     */
	virtual ~WheeledCreatureGenotype();
...
#endif //_WHEELEDCREATUREGENOTYPE_H_
