/**     
    ...
    Roal is free software; you can redistribute it anVehicleSuspensionJointd/or modify
...
*/
#include "VehicleSuspensionJoint.h"

namespace Roal
{
    
//------------------------------------------------------------------------------
VehicleSuspensionJoint::VehicleSuspensionJoint(Roal::Position* anchor)
:Joint(anchor)
{ 
}
...
//------------------------------------------------------------------------------
void VehicleSuspensionJoint::initJoint()
{
    ...
    if(this->getIsRunnable()) {
        ...
        throw(RoalException(typeid( this ).name(),
              "Couldn't initJoint: because the Joint is not runnable"));
    }
}
