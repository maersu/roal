...
*/
#ifndef _DISTRIBUTEDWALKERAGENT_H_
#define _DISTRIBUTEDWALKERAGENT_H_
...
/**
 * The Agent implementation for the distributed walker example.
 * 
 ...
 */
class DistributedWalkerAgent : public DistributedAgent
{
public:
     ...
     */
    DistributedWalkerAgent(const string name, DistributedWorld* world,
...
#endif //_DISTRIBUTEDWALKERAGENT_H_
