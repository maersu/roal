...
*/
#ifndef _VICTIMBRAITENBERGBRAIN_H_
#define _VICTIMBRAITENBERGBRAIN_H_
...
{
/**
 * VictimBraitenbergBrain is the Brain implementation for the Braitenberg creature.
 * @see Brain
 * 
 ...
 */
class VictimBraitenbergBrain : public Brain
{
public:
    /**
     * Constructor
     ...
     */
	VictimBraitenbergBrain(const std::string name);
    
    /**
     * Destructor  
     */
	virtual ~VictimBraitenbergBrain();
     ...
     * 
     * @exception Throws a RoaVictimBraitenbergBrainlException if the Body is no a Braitenberg.
     */
...
protected:
    ...
    /**
     * The age of the Braitenberg creature.
     */
    float age;
...
#endif //_VICTIMBRAITENBERGBRAIN_H_
